...
newtype SupervisorType childStartArg childProcess = SupervisorType Void

newtype SupervisorPid :: Type -> Type -> Type
newtype SupervisorPid childStartArg childProcess = SupervisorPid Pid
...
type SupervisorInstance childStartArg childProcess = RegistryInstance (SupervisorPid childStartArg childProcess) (SupervisorType childStartArg childProcess)
